...
class AllCountriesTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.CountryImage.image = UIImage(named: countries[indexPath.row].flag)
        cell?.CountryNameAndSymbol.text = "\(countries[indexPath.row].code) - \(countries[indexPath.row].name)"
